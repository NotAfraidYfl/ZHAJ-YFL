...
/**
 * 新增 提示消息 layer.alert 弹窗 btn: ["返回列表","继续添加"]
 * 
 * @param option
 *            显示的内容
 * @param yesCallback
...
/**
 * 系统内部错误 提示消息 layer.alert提示 btn: ["取消"]
 * 
 * @param cancelCallback
 *            点击[取消]回调函数
 */
...
/**
 * 判断是否传递参数icon 没有传就根据option判断图标 option.code == 0 ? icon=1 : icon=2 icon=1
 * 操作成功图标 勾 icon=2操作失败图标 叉
 * 
 * @param option
 */
