			...
			<div class="container">
				<div class="gallery-grids">
					<div class="col-md-6 gallery-grid2">
						<a href="${ctx}/static/images/g1.jpg" class="swipebox"><span
							class="rollover1"> </span></a> <img src="${ctx}/static/images/g1.jpg"
							class="img-responsive" alt="/">
					</div>
					<div class="col-md-6 gallery-grid2">
						<a href="${ctx}/static/images/g2.jpg" class="swipebox"><span
							class="rollover1"> </span></a> <img src="${ctx}/static/images/g2.jpg"
							class="img-responsive" alt="/">
					</div>
				...
				<div class="gallery-grids galry">
					<div class="col-md-6 gallery-grid2">
						<a href="${ctx}/static/images/g3.jpg" class="swipebox"><span
							class="rollover1"> </span></a> <img src="${ctx}/static/images/g3.jpg"
							class="img-responsive" alt="/">
					</div>
					<div class="col-md-6 gallery-grid2">
						<a href="${ctx}/static/images/g4.jpg" class="swipebox"><span
							class="rollover1"> </span></a> <img src="${ctx}/static/images/g4.jpg"
							class="img-responsive" alt="/">
					</div>
					<div class="clearfix"></div>
				</div>
		...
		<div class="container">
			<p>
				...
				Templates <a href="http://www.cssmoban.com/" target="_blank"
					title="西南科技大大学">西南科技大学</a> - Collect from <a
					href="www.swust.edu.cn " title="西南科技大学" target="_blank">SWUST</a>
			</p>
		</div>
	</div>
	<!--copy-->
