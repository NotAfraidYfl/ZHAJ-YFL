				...
				<ul>
					...
					<c:if test="${empty sessionScope.loginUser.userId}">
						<li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i>
							<a href="#" data-toggle="modal" data-target="#myModal">登陆</a></li>
						<li><i class="glyphicon glyphicon-lock" aria-hidden="true"></i>
							<a href="#" data-toggle="modal" data-target="#myModal1">注册</a></li>
					</c:if>
					<c:if test="${not empty sessionScope.loginUser.userId}">
						<li class="dropdown"><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i>
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"
							role="button" aria-haspopup="true" aria-expanded="false">欢迎${sessionScope.loginUser.userName}</a>
							<ul class="dropdown-menu">
								<li><a href="#">个人资料</a></li>
								<li><a href="#">登出</a></li>
							</ul></li>
						<li><i class="glyphicon glyphicon-lock" aria-hidden="true"></i>
							<a href="#" data-toggle="modal" data-target="#myModal1">登出</a></li>
					</c:if>
				</ul>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					<li onclick="navLocated(this,0)"><a
						href="${ctx}/home/index.do">首页 <span class="sr-only">(current)</span></a>
					</li>
				...
				<c:if test="${not empty sessionScope.loginUser.userId}">
					<div class="house-config">
						<a onclick="changeLocalStorage()"
							style="text-decoration: none; color: #fff; font-family: cursive;"
							href="${ctx}/house/houList.do"><span><i
								class="glyphicon glyphicon-home" aria-hidden="true"></i>房源管理</span> </a>
					</div>
				</c:if>
				<div class="clearfix"></div>
			</div>
				...
				<div class="login-grids">
					<div class="login">
						...
						<div class="login-right">
							<form id="loginForm" action="${ctx}/loginAndRegist/login.do">
								<h3>登陆</h3>
								<input type="text" value="请输入您的用户名" name="userName"
									onfocus="this.value = '';"
									onblur="if (this.value == '') {this.value = '请输入您的用户名';}"
									required=""> <input type="password" value=请输入你的密码
									name="userPassword" onfocus="this.value = '';"
									onblur="if (this.value == '') {this.value = '请输入您的密码';}"
									required="">
								<h4>
					...
					<p>
						通过登录您同意我们的 <a href="#">条款</a> 和 <a href="#">隐私政策</a>
					</p>
				</div>
			</div>
		</div>
						...
						<div class="login-right">
							<form id="registerForm">
								...
								<input type="text" name="userName" value="Name"
									...
									required=""> <input type="text" name="userTel"
									value="Mobile number" onfocus="this.value = '';"
									onblur="if (this.value == '') {this.value = 'Mobile number';}"
									required=""> <input type="text" name="userEmail"
									value="Email id" onfocus="this.value = '';"
									...
									onclick="registNow(this);return false;">
							</form>
						</div>
						<div class="clearfix"></div>
					</div>
